Public Class Sacar_Dinero

    Private Sub btnAceptar_Click(sender As Object, e As EventArgs) Handles btnAceptar.Click
        If (lblMensaje.Text = "" Or lblMensaje.Text = "Imposible realizar la transacción requerida.") Then
            lblMensaje.Text = Controlador.sacarDinero(txtCant.Text, MetodosPrincipal._cuenta._nCuenta)
        Else
            Me.Close()
        End If
    End Sub
